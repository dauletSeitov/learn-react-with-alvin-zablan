    ...
    return (
        <div className="border border-slate-200 m-2 p-4 bg-white flex justify-between">
            ...
            <div className="flex flex-col items-end">
                <div className={clsx("text-sm rounded-full p-1 w-16 text-center", percentChange > 0 ? "bg-green-200 text-green-700" : "bg-red-200 text-red-700")}>{percentChange.toFixed(2)}%</div>
                <div className="text-slate-700 text-2xl">${stock.current_price/100}</div>
            </div>
