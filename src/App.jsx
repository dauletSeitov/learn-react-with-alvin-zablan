...
import { DefaultLecture } from "./default-lecture/DefaultLecture";
import { UseEffectCleanUp } from "./use-effectclean-up/UseEffectCleanUp";
import { ScreenSizeBreakpoints } from "./screen-size-breakpoints/ScreenSizeBreakpoints";
...
const App = () => {
  return (
    <div id="d0">
      ...
      <Description />
      <Description />
      <Message text="this is my first props" bgColor="red"></Message>
      <Message text="hi" bgColor="green"></Message>
      <Message text="bye" bgColor="blue"></Message>
      <Box
      ...
      <Box
        ...
        large={false}
      />
      <Box label="green stuf" bgColor="Green" textColor="White" large={false} />
      <MyComponents bgColor="Yellow" height={90}>
        hello!
      </MyComponents>
      <MyComponents bgColor="Lavender" height={40}>
        goodbye!
      </MyComponents>
      ...
      <div>place holder</div>
      <div className="text-slate-400 border-b-4 border-black">
        border bottom
      </div>
      <div>place holder</div>
      ...
      <div className="border-2 border-red-500 p-4 m-4">hrllo</div>
      <div className="border-2 border-blue-500 px-4 m-4">bye</div>
      <button className="border-2 bordr-green-600 text-green-400 px-8 py-2 m-4 rounded-md">
        first
      </button>
      <button className="rounded-lg bg-sky-400 text-white px-10 py-4 text-3xl m-4 hover:text-base">
        second
      </button>
      <button className="bg-violet-100 text-violet-600 px-10 px-8 py-2 rounded-full">
        third
      </button>
